...
export default function PoolFinder() {
  ...
  return (
    <>
      {/* <AppBody> */}
      <FindPoolTabs origin={query.get('origin') ?? '/order?mode=liquidity'} />
      <AutoColumn gap="md">
        <LightCard>
          <AutoColumn gap="10px">
        ...
        >
          {currency0 ? (
            <Row>
              ...
              <Text fontWeight={500} fontSize={20} marginLeft={'12px'} fontFamily={FONT}>
                {currency0.symbol}
              </Text>
            </Row>
          ) : (
        ...
        {hasPosition && (
          ...
          >
            <Text textAlign="center" fontWeight={500} fontFamily={FONT}>
              Pool Found!
            </Text>
            <StyledInternalLink to={`/order?mode=liquidity`}>
              <Text textAlign="center" fontFamily={FONT}>
                Manage this pool.
              </Text>
            </StyledInternalLink>
          </ColumnCenter>

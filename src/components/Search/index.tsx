import { POOL_HIDE, TOKEN_HIDE } from 'constants/addresses'
...
import { FONT, HideSmall, TYPE } from '../../theme'
        ...
        <Menu hide={!showMenu} ref={menuRef}>
          <AutoColumn gap="lg">
            ...
            {tokensForList
              ...
              .map((t, i) => {
                return (
                  <HoverRowLink onClick={() => handleNav('/' + 'order?outputCurrency=' + t.address)} key={i}>
                    <ResponsiveGrid>
                      <RowFixed>
            ...
            {poolForList
              ...
              .map((p, i) => {
                return (
                  <HoverRowLink onClick={() => handleNav('/' + 'order?pool=' + p.address)} key={i}>
                    <ResponsiveGrid key={i}>
                      ...
                      <HideSmall>
                        <TYPE.label textAlign="end">{formatDollarAmount(p.trackedReserveUSD)}</TYPE.label>
                      </HideSmall>
                      <HideSmall>
